module UPS
  module RequestXML
    ...
    class AddressValidationRequestNode < Base
      attr_reader :address_line1, :city, :state, :zip, :country
        ...
        request = Nokogiri::XML::Builder.new do |xml|
          xml.AddressValidationRequest{
            xml.Request{
              ...
              xml.RequestOption '1' # 1 for Address Validation.  Can also do Classification (2) or both, (3)
            }
            xml.MaximumListSize 0 # We don't want any correction options returned.
